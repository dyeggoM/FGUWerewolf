...
function capitalizeAll(s)
	...
	return s:gsub("^%l", string.upper):gsub("%W%l", string.upper);
end
...
function findDiceMathExpression(s, nStart)
	...
	ChatManager.SystemMessage("StringManager.findDiceMathExpression - DEPRECATED - 2022-02-01 - Contact forge/extension author");
	return nil;
end
