...
function onDesktopInit()
	if Session.IsHost then
		Token.onContainerChanged = TokenManager.onContainerChanged;
		Token.onTargetUpdate = TokenManager.onTargetUpdate;
		User.onIdentityStateChange = TokenManager.onIdentityStateChange;

		CombatManager.setCustomDeleteCombatantHandler(TokenManager.onCombatantDelete);
		CombatManager.addCombatantFieldChangeHandler("active", "onUpdate", TokenManager.updateActive);
	...
	Token.onAdd = TokenManager.onTokenAdd;
	Token.onDelete = TokenManager.onTokenDelete;
	Token.onDrop = TokenManager.onDrop;
	Token.onHover = TokenManager.onHover;
	Token.onDoubleClick = TokenManager.onDoubleClick;

	CombatManager.addCombatantFieldChangeHandler("tokenrefid", "onUpdate", TokenManager.updateAttributes);
	CombatManager.addCombatantFieldChangeHandler("friendfoe", "onUpdate", TokenManager.updateFaction);
	CombatManager.addCombatantFieldChangeHandler("name", "onUpdate", TokenManager.updateName);
	CombatManager.addCombatantFieldChangeHandler("nonid_name", "onUpdate", TokenManager.updateName);
	CombatManager.addCombatantFieldChangeHandler("isidentified", "onUpdate", TokenManager.updateName);
...
function onContainerChanged(tokenCT, nodeOldContainer, nOldId)
	if nodeOldContainer then
		...
		if nodeCT then
			...
			ImageManager.onTokenAdd(tokenCT);
		end
	end
